    ...
    <div class="container mx-auto mt-16 px-9 py-9">
        ...
        <div class="header w-full flex justify-center">
            <div class="text-xl flex flex-col items-center justify-center gap-4 w-[600px] h-[250px] relative">
                ...
                <div class="head-btn rounded-sm absolute top-4 right-[135px]">
                    <a href="#" class="surah-info flex flex-row text-sm p-[5px] translate-x-[2px]">
                        <svg 
                    ...
                    <a href="{{ route('tafsir.index', $detailSurah['nomor']) }}" class="surah-info flex flex-row text-sm p-[5px] mt-1">
                        <svg 
